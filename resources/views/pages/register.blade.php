            ...
            <div class="card-body">
                <form>
                    <div class="input-group form-group">
                        ...
                        <input type="text" name="user" class="form-control" placeholder="Tên đăng nhập tài khoản" required>   
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('login2') }}" style="color:white; font-weight: bold;">Đã có tài khoản? Đăng nhập ngay</a>
                    </div>
                </form>
            </div>
