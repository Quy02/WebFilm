                ...
                <div class=" user-actions" style="float: right; margin-top: 10px;">
                              <div style="text-align: right;">
                                  ...
                                  @else
                                      ...
                                      <a href="{{ route('login2') }}" style="background-color: #0a64bbc9; color: white; padding: 10px 10px; border: 1px solid #4CAF50; border-radius: 5px; text-decoration: none; cursor: pointer;">Đăng nhập</a>
                                  @endif
                              </div>
               </div>
            ...
            $('#timkiem').keyup(function() {
                ...
                if (search !== '') {
                    ...
                    searchResults.forEach(function(result) {
                        ...
                        $('#result').append('<li class="list-group-item" style="cursor:pointer"><img height="40" width="40" src="/uploads/movie/'+value.image+'">'+value.title+'<br/> | <span>'+value.description+'</span>  <br/>  </li>');
                    });
                } else {
                    $('#result').css('display', 'none');
                }
